...
<ul class="topnav">
	<li><a href="#" >Artikel bearbeiten/löschen</a>
		<ul>
			<li><a href="">gelötete Wärmetauscher</a></li>
			<li><a href="">Pufferspeicher</a></li>
			<li><a href="">Wassererwärmer</a></li>
		</ul></li>
	<li><a href="#">Artikel hinzufügen</a>
		<ul>
			...
			<li><a href="/Wassererwaermer/hinzufuegen">Wassererwärmer</a></li>
		</ul></li>
	<li><a href="#">Angebote bearbeiten</a></li>
</ul>