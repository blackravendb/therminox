...
--
-- Host: localhost
-- Erstellungszeit: 05. Jan 2014 um 15:28
...
('test@test.de', 'test', 'test', 'b0014d0e690fa1080574f2f6096b532eb4880cc6', '6f00afc6550ad5c19d20288ab7545771b4a66c10', 'Benutzer', 1, 0);
...
ALTER TABLE `waermetauscher`
  ADD CONSTRAINT `waermetauscher_ibfk_2` FOREIGN KEY (`stutzenmaterial_id`) REFERENCES `anrede` (`id`);
